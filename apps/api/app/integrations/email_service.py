...
FROM_ADDRESS = "QFinance <noreply@qfinance.example>"  # placeholder domain — not a real sending domain
...
def send_verification_email(*, to_email: str, verification_link: str) -> dict:
    ...
    return _send_or_skip(
        to_email=to_email,
        subject="Verify your QFinance email address",
        html_body=f'<p>Confirm your email to finish setting up your QFinance account.</p>'
                  f'<p><a href="{verification_link}">Verify email address</a></p>'
                  f'<p>This link expires in 24 hours. If you did not create a QFinance account, ignore this email.</p>',
...
def send_password_reset_email(*, to_email: str, reset_link: str) -> dict:
    ...
    return _send_or_skip(
        to_email=to_email,
        subject="Reset your QFinance password",
        html_body=f'<p>A password reset was requested for your QFinance account.</p>'
